...
construção, castelo"-reboco, como diríamos castelo"-pontudo.\protect\footnote{A~palavra~{\slsc{crépi}} se traduz por ``reboco''; {\slsc{chapeau- -pointu}} é
o tipo de chapéu com a forma pontiaguda. {\slsc{Chapeau}} e
{\slsc{chateaux}} em Francês soam de modo parecido. Em seguida,
 {\slsc{crépi}} aparece como nome próprio, e, portanto, é a essa relação
...
bolsista; aluno do liceu:\protect\footnote{\protect{O liceu era e continua sendo a
