...
\titleformat{\section}
[display]
{\normalsize\scshape\MakeTextLowercase\Formular}
 {\normalsize\sectiontitlename\space\thesection}
  {20pt}
  {\baselineskip=.7\baselineskip\centering}
...
%ItalicFont = Formular-regularitalic.otf]
%\newfontfamily\Cobraarisca{Cobra arisca-Regular}
%\newfontfamily\fakereceipt{fake receipt}

\newfontfamily\Formularteste{Formular-Light}[
ItalicFont = Formular-Lightitalic.otf]
...
\usepackage{etoolbox}
\makeatletter
\patchcmd{\@footnotetext}{\footnotesize}{\scriptsize\sffamily\protect}{}{}
\makeatother
...
\pagestyle{fancy}
\fancyhf{}
\fancyfoot[CE,CO]{\Formular \footnotesize \thepage}
\renewcommand{\headrulewidth}{0pt}
