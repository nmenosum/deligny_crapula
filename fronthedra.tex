...
\linhalayout{\emph{conselhos aos educadores que queiram cultivá-la}}{}
...
\linhalayout{revisão técnica da tradução}{Cícero Oliveira}
...
\mbox{conselhos aos educadores \hspace{0.4cm}conselhos aos educadores \hspace{0.45cm}conselhos aos educadores}\vspace*{-3pt}
\mbox{que queiram cultivá-la \hspace{1.2cm}que queiram cultivá-la \hspace{1.3cm}que queiram cultivá-la}}
